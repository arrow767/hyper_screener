...
export interface Config {
  ...
  /**
   * Окно для расчета shock1 (в минутах), например 30.
   * Используется в policy правилах как shock30mNatr (если = 30).
   */
  policyShockWindow1Min: number;
  /**
   * Окно для расчета shock2 (в минутах), например 60.
   * Используется в policy правилах как shock60mNatr (если = 60).
   */
  policyShockWindow2Min: number;
  /**
